;(function ($) {
        ...
        $(window).on('load resize', function () {
            if ($().owlCarousel) {
                $('.flat-carousel-box').each(function () {
                    var
                        $this = $(this), auto = $this.data("auto"), item = $this.data("column"),
                        item2 = $this.data("column2"), item3 = $this.data("column3"), item4 = $this.data("column4"),
                        loops = $this.data("loop"), gap = Number($this.data("gap")), dots = $this.data("dots"),
                        nav = $this.data("nav");
                    $this.find('.owl-carousel').owlCarousel({
                        ...
                        responsive: {0: {items: item4}, 600: {items: item3}, 768: {items: item2}, 1000: {items: item}}
                    });
    ...
    var headerFixed = function () {
        var top_height = $('.top-bar').height(), hd_height = $('.header').height();
        ...
        $(".flat-courses").each(function () {
            if ($().isotope) {
                ...
                $container.imagesLoaded(function () {
                    $container.isotope({itemSelector: '.course', transitionDuration: '1s', layoutMode: 'fitRows'});
                });
    ...
    var tabs = function () {
        $('.flat-tabs').each(function () {
            var
                list = "", title = $(this).find('.item-title'), titleWrap = $(this).children('.tab-title');
    ...
    var countDownTime = function () {
        $(".count-time").each(function () {
            var day = $(".count-time").data("day"), month = $(".count-time").data("month") - 1,
                year = $(".count-time").data("year"), hour = $(".count-time").data("hour"),
                minute = $(".count-time").data("minutes"), second = $(".count-time").data("second");
        ...
        $('.partner-clients').each(function () {
            if ($().owlCarousel) {
                $('.slide-client').owlCarousel({
                    ...
                    responsive: {0: {items: 2}, 600: {items: 3}, 1000: {items: $('.slide-client').data('item')}}
                });
            }
        });
    };
